...
const WEDDING_CONFIG = {
  ...
  messages: {
    ...
    welcome: "Việc xác nhận tham dự sẽ giúp chúng mình chuẩn bị mọi thứ được trọn vẹn và chu đáo hơn.",

    eventSubtitle: "Sự hiện diện của bạn là niềm vinh dự của chúng tôi!", // Text below countdown

    gift: "Chúng mình rất mong được gặp bạn trong ngày vui. Nếu chưa thể sắp xếp đến trực tiếp, mọi lời chúc từ bạn đều là món quà quý giá rồi.",
  },
  ...
  music: {
    ...
    // - YouTube/SoundCloud: Download MP3 first, then upload to music/ folder
  }
};
